...
class Luzuk_United_Soccer_Club_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function luzuk_united_soccer_club_loadClassLoader($class)
    {
    ...
    public static function luzuk_united_soccer_club_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }

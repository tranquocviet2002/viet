...
class Luzuk_United_Soccer_Club_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function luzuk_united_soccer_club_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function luzuk_united_soccer_club_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function luzuk_united_soccer_club_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function luzuk_united_soccer_club_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->luzuk_united_soccer_club_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function luzuk_united_soccer_club_load( $class ) {

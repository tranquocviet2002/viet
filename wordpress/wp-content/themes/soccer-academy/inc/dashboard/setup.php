...
<div class="theme-offer">
  ...
  if(isset($_GET['import-demo'])){
    ...
    if (!$menu_exists) {
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Home', 'soccer-academy'),
      ...
      $parent_page_item_id = wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Pages', 'soccer-academy'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Left Sidebar', 'soccer-academy'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'   => __('Page Right Sidebar', 'soccer-academy'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('About Us', 'soccer-academy'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('News', 'soccer-academy'),
      ...
      wp_update_nav_menu_item($menu_id, 0, array(
          'menu-item-title'  => __('Contact Us', 'soccer-academy'),
    ...
    set_theme_mod( 'soccer_academy_call_number', '0800 2537 9901' ); 

    set_theme_mod( 'soccer_academy_email_address', 'support@example.com' ); 

    // --------Social icons------------------------

    set_theme_mod( 'soccer_academy_twitter', 'https://twitter.com/' ); 

    set_theme_mod( 'soccer_academy_linkedin', 'https://linkedin.com/' );

    set_theme_mod( 'soccer_academy_youtube', 'https://youtube.com/' ); 

    set_theme_mod( 'soccer_academy_instagram', 'https://instagram.com/' );

    //-------------- SLIDER-----------------------

    set_theme_mod( 'soccer_academy_slide_heading', 'Welcome To Our Soccer Club' ); 

    for($i=1;$i<=4;$i++){

      $title = 'Passion Always Dominates';
      ...
      set_theme_mod('soccer_academy_post_setting' . $i, $slider_post_id);

    }

    //-------------- PLAYER-----------------------

    set_theme_mod( 'soccer_academy_player_sub_heading', 'CLUB PLAYER' );

    set_theme_mod( 'soccer_academy_player_heading', 'Club & Top Player' );

    set_theme_mod( 'soccer_academy_top_player_counter', 3 );

    for($i=1;$i<=3;$i++){

      set_theme_mod( 'soccer_academy_top_player_images'.$i, get_template_directory_uri().'/assets/images/player.png' );

      set_theme_mod( 'soccer_academy_player_1'.$i, 'Esther Howard' );

      set_theme_mod( 'soccer_academy_team_name'.$i, 'England' );

      set_theme_mod( 'soccer_academy_player_no'.$i, '07' );

      set_theme_mod( 'soccer_academy_player_b'.$i, '16 Feb 1988' );

      set_theme_mod( 'soccer_academy_player_a'.$i, '40 Year' );

      set_theme_mod( 'soccer_academy_player_c'.$i, 'USA' );

      set_theme_mod( 'soccer_academy_height'.$i, '6' );

      set_theme_mod( 'soccer_academy_weight'.$i, '65' );
    }
    
  } ?>
    
  <p class="note"><?php esc_html_e("If your website is already live and containing data, please make a backup.This importer will override the Soccer Academy's new customizable values.",'soccer-academy'); ?></p>
  <form id="mep-demo-importer-form" action="<?php echo esc_url(home_url()); ?>/wp-admin/themes.php?page=soccer-academy-guide-page" method="POST">
    <input type="submit" name="submit" value="<?php echo esc_attr('Begin With Demo Import','soccer-academy'); ?>" class="button button-primary button-large">
    <a href="<?php echo esc_url(home_url('/')); ?>" target="_blank" class="button button-primary button-large"><?php esc_html_e('View Site','soccer-academy'); ?></a>
  </form>
  <div class="mep-spinner-div"><p class="spinner"></p></div>
  <div class="success">
    <?php if (isset($_GET['import-demo'])) {
      echo esc_html('Demo Import Successful','soccer-academy');
    } ?>
  </div>
  ...
  <script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
      ...
      if(searchParams) {
        history.replaceState({}, '', 'themes.php?page=soccer-academy-guide-page')
      }

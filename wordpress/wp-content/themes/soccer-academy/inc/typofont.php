...
function soccer_academy_custom_styles($custom) {
	...
	if ( $soccer_academy_headings_font ) {
		...
		$font_pieces = explode(":", $soccer_academy_headings_font);
	...
	if ( $soccer_academy_body_font ) {
		...
		$font_pieces = explode(":", $soccer_academy_body_font);
	...
	wp_add_inline_style( 'soccer-academy-style', $custom );

}
add_action( 'wp_enqueue_scripts', 'soccer_academy_custom_styles' );

//Sanitizes Fonts
function soccer_academy_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',

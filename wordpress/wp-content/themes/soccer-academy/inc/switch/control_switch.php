 ...
 * Control - Switch.
 *
 * @package Soccer Academy Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Soccer_Academy_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'soccer-academy-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'soccer-academy-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
